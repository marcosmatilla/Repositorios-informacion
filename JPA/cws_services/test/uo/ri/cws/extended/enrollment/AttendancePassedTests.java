...
public class AttendancePassedTests {
	...
	public void setUp() throws Exception {
		...
		course = new Course("course", "1o1", "description",
				...
				Dates.fromDdMmYyyy(25, 11, 2019), 100 /* hours */
		);
	...
	public void testAttendedNotPassed() {
		...
		Enrollment e = new Enrollment(mechanic, course, ENOUGH_TO_PASS,
				NOT_PASSED);
	...
	public void testNoSetters() {
		try {
			ReflectionUtil.getMethodOfClass(Enrollment.class, "setPassed",
					boolean.class);
		...
		try {
			ReflectionUtil.getMethodOfClass(Enrollment.class, "setAttendance",
					int.class);
			fail("There should't be this setter on this class");
		} catch (IllegalStateException e) {
			// expected result
