package uo.ri.business.serviceLayer.administrator.training.report;
...
public interface CourseReportService {
	 ...
	 */
	List<TrainingForMechanicRow> findTrainigByMechanicId(Long id) throws BusinessException;
	 ...
	 * @throws BusinessException, DOES NOT
	 */
	List<TrainingHoursRow> findTrainingByVehicleTypeAndMechanic() throws BusinessException;
	 ...
	 * @throws BusinessException, DOES NOT
	 */
	List<CertificateDto> findCertificatedByVehicleType() throws BusinessException;
}
